...
const DATA = {
  ...
  sheets: {
    ...
    ecoles_iepp_colonnes: {
      INSPECTION:        "Inspection concernée",           // Ex: "IEPP 1 AGBOVILLE"
      CYCLE:             "Cycle",                          // Ex: "Primaire" ou "Maternelle"
      TYPE:              "Type d'établissement",           // Ex: "Public" ou "Privé"
      CODE_ECOLE:        "Code de l'école",
      NOM_ECOLE:         "Nom de l'école",
      NOM_DIRECTEUR:     "Nom du directeur / directrice",
      CONTACT_DIRECTEUR: "Contact du directeur",
